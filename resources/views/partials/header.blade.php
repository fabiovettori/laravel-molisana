        ...
        <div class="row">
            <div class="col-lg-12 text-center">
                <ul class="d-flex justify-content-between list-unstyled m-0">
                    ...
                    <li><a href="#">news</a></li>
                    <li><a href="#">
                        <svg class="mk-svg-icon" data-name="mk-li-cart" data-cacheid="icon-5fe1bce557d04" style=" height:16px; width: 16px; " xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
